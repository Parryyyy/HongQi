...
- (void)viewDidLoad {
    ...
    [backGround setImage:[UIImage imageNamed:@"homeBackground"]];
    ...
    [closeBtn setImage:[UIImage imageNamed:@"CL_WDG_Status_Home_N"] forState:UIControlStateNormal];
...
//    [myScrollView addSubview:second];
    ForthView *second = [[ForthView alloc] initWithFrame:CGRectMake(kScreenWidth*3, 0, kScreenWidth, kScreenHeight-TopHeight)];
    [myScrollView addSubview:second];
