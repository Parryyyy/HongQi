...
- (id)initWithFrame:(CGRect)frame{
    ...
    [upYinYing setImage:[UIImage imageNamed:@"upYinYing"]];
    ...
    [downYinYing setImage:[UIImage imageNamed:@"downYinYing"]];
...
- (void)setLeftView{
    ...
    for (int i = 0; i < 5; i++) {
        ...
        [btn setTitleColor:[UIColor colorWithRed:146/255.0 green:114/255.0 blue:221/255.0 alpha:1] forState:UIControlStateSelected];
