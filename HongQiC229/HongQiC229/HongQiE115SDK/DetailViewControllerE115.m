...
@interface DetailViewControllerE115 ()
...
@implementation DetailViewControllerE115
{
    NSArray *dataArr;
    UIView *backView;
...
- (void)setDataDic:(NSDictionary *)dataDic{
    ...
    [closeBtn setImage:[UIImage imageNamed:@"neirongguanbianniu"] forState:UIControlStateNormal];
...
- (void)setback{
    ...
    [backImage setImage:[UIImage imageNamed:@"neirongyebeijingtu1"]];
...
- (UIButton *)startBtn{
    ...
    [_startBtn setImage:[UIImage imageNamed:@"starPlayBtnImage"] forState:UIControlStateNormal];
...
- (UIView *)reStartView{
    ...
    [img setImage:[UIImage imageNamed:@"restarone"]];
    ...
    [button setImage:[UIImage imageNamed:@"chongxinbofang"] forState:UIControlStateNormal];
