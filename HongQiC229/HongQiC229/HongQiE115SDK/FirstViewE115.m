...
- (void)changeImage{
    NSString *imageName = [NSString stringWithFormat:@"hq229-%d",total];
    [_carImage setImage:[UIImage imageNamed:imageName]];
}
- (void)addScrollView{
...
- (void)setAllLineAndImageFrame:(int)x{
    ...
    switch (x) {
        ...
        case 1:{
            ...
            [ssImg1 setImage:[UIImage imageNamed:@"车灯近.png"]];
            ...
            [ssImg2 setImage:[UIImage imageNamed:@"后备箱近.png"]];
            ...
            [ssImg3 setImage:[UIImage imageNamed:@"无名近.png"]];
